...
2. The nuproj files (in nanoFramework.Windows.Devices.SerialCommunication.Nuget.sln) have to be manually updated for the dependency versions to match the referenced packages.
